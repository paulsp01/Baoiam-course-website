        ...
        ">
            ...
            <div className='shadow-2xl flex  mx-auto max-w-4xl my-10 bg-white rounded-2xl ' >
                <div className='md:w-3/5 w-full p-5'>
                    ...
                    <div className="py-10">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mb-5 w-64 flex justify-between">
                            ...
                            <Link to="#" className="border-2 border-amber-500 text-amber-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-amber-500 text-nowrap hover:text-white">Sign In</Link>

                            <Link to="/signup" className='text-gray-400 my-3 text-sm md:hidden hover:text-gray-800'>New User?</Link>
                        </div>
                    </div>
                </div>
                {/* Sign in Section */}
                ...
                <div className="w-2/5 md:block hidden bg-amber-500 text-white rounded-r-2xl py-36 px-12 " ref={rightDivRef}>
                    ...
                    <Link to="/signup" className="border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white text-nowrap hover:text-amber-500">Sign Up</Link>
